...
class FrequencyFlowerVisualizer(BaseVisualizer):
    ...
    def _draw_petal(
        ...
        for i in range(len(points)):
            ...
            draw.line(
                [(x1, y1), (x2, y2)], fill=outline_color, width=max(1, int(rms * 2))
            )
        ...
        draw.ellipse(
            [
                mid_x - highlight_radius,
                mid_y - highlight_radius,
                mid_x + highlight_radius,
                mid_y + highlight_radius,
            ],
    ...
    def _draw_stamen(
        ...
        for i in range(num_stamens):
            ...
            draw.ellipse(
                [x - stamen_size, y - stamen_size, x + stamen_size, y + stamen_size],
                fill=color,
            )
